...
public class TestExpensiveResourceCache {
	...
	public void testCacheReturnsASprocket() {
		...
		ExpensiveResource expensiveResource = cache.getWithReadWriteLock("key");
	...
	public void testCacheReturnsSameObjectForSameKey() {
		...
		ExpensiveResource expensiveResource1 = cache.getWithReadWriteLock("key");
		ExpensiveResource expensiveResource2 = cache.getWithReadWriteLock("key");
    ...
    public void testCacheReturnsDifferentObjectsForDifferentKeys() {
		ExpensiveResourceCache cache = new ExpensiveResourceCache(slowExpensiveResourceFactory);
		ExpensiveResource expensiveResource1 = cache.getWithReadWriteLock("key1");
		ExpensiveResource expensiveResource2 = cache.getWithReadWriteLock("key2");
	...
	public void testCacheTimeout() throws InterruptedException {
		...
		ExpensiveResource beforeTimeoutExpensiveResource = cache.getWithReadWriteLock("key");
		...
		ExpensiveResource itemRefreshedAfterTimeout = cache.getWithReadWriteLock("key");
    ...
    public void testThreadSafe() {
		...
		CompletableFuture<ExpensiveResource> firstThreadResult =
				CompletableFuture.supplyAsync(() -> cache.getWithReadWriteLock("key1"), service);
