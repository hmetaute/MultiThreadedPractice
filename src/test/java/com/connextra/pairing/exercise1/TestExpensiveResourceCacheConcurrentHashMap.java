...
public class TestExpensiveResourceCacheConcurrentHashMap {
    ...
    public void testCacheReturnsASprocket() {
        ...
        ExpensiveResource expensiveResource = cache.getWithConcurrentHashMap("key");
    ...
    public void testCacheReturnsSameObjectForSameKey() {
        ...
        ExpensiveResource expensiveResource1 = cache.getWithConcurrentHashMap("key");
        ExpensiveResource expensiveResource2 = cache.getWithConcurrentHashMap("key");
    ...
    public void testCacheReturnsDifferentObjectsForDifferentKeys() {
        ExpensiveResourceCache cache = new ExpensiveResourceCache(slowExpensiveResourceFactory);
        ExpensiveResource expensiveResource1 = cache.getWithConcurrentHashMap("key1");
        ExpensiveResource expensiveResource2 = cache.getWithConcurrentHashMap("key2");
    ...
    public void testCacheTimeout() throws InterruptedException {
        ...
        ExpensiveResource beforeTimeoutExpensiveResource = cache.getWithConcurrentHashMap("key");
        ...
        ExpensiveResource itemRefreshedAfterTimeout = cache.getWithConcurrentHashMap("key");
    ...
    public void testThreadSafe() throws ExecutionException, InterruptedException {
        ...
        CompletableFuture<ExpensiveResource> firstThreadResult =
                CompletableFuture.supplyAsync(() -> cache.getWithConcurrentHashMap("key1"), service);
        ...
        firstThreadResult.thenAcceptBoth(secondThreadResult, (firstResult, secondResult) ->
                assertEquals("The cache should return the same object for the two different threads", firstResult, secondResult));
